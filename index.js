document.addEventListener('DOMContentLoaded', function () {
  ...
  'tech-url_launcher': 'Url_Launcher',
  'tech-utils': 'Utils',
  
  // Kotlin/Android
  'tech-kotlin': 'Kotlin',
  'tech-compose': 'Compose',
  'tech-material3': 'Material3',
  'tech-viewmodel': 'ViewModel',
  'tech-stateflow': 'StateFlow',
  'tech-ktor': 'Ktor',
  'tech-coil': 'Coil',
    ...
    const createProjectCard = (project, isDynamic = false) => {
      ...
      return `
        <article class="portfolio-item fade-in ${dynamicClass}">
          <a href="${project.mainlink}" target="_blank" rel="noopener noreferrer" class="portfolio-link">
